...
/* harmony default export */ __webpack_exports__["a"] = ({
    ...
    data: () => {
        return {
            tools: [{ id: 1, tool: 'pen', size: 1, icon: "fas fa-pencil-ruler", callback: _this.a.methods.paint }, { id: 2, tool: 'color', size: 1, icon: "fas fa-palette", callback: _this.a.methods.picker }, { id: 3, tool: 'fill', size: 1, icon: "fas fa-fill", callback: _this.a.methods.fill }, { id: 4, tool: 'close', size: 1, icon: "fas fa-times", callback: _this.a.methods.close }],
            width: 80
            // mainColor: color
        };
    },
    methods: {
        open: ev => {
            let toolbar = document.querySelector('div.tools');
            if (toolbar.offsetWidth == 80) {
                let tools = toolbar.children.length;
                toolbar.style.width = 80 * tools + 'px';
            }
        },
        close: () => {
            let toolbar = document.querySelector('div.tools');
        ...
        paint: () => {},
        picker: () => {
            let picker = document.querySelector('.vc-chrome');
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_Table_vue__ = __webpack_require__(18);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_Toolbox_vue__ = __webpack_require__(22);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_vue_color__ = __webpack_require__(26);
...
__WEBPACK_IMPORTED_MODULE_0_vue__["a" /* default */].component("chrome-picker", __WEBPACK_IMPORTED_MODULE_4_vue_color__["Chrome"]);
__WEBPACK_IMPORTED_MODULE_0_vue__["a" /* default */].component("toolbox", __WEBPACK_IMPORTED_MODULE_3__components_Toolbox_vue__["a" /* default */]);

const tableVue = new __WEBPACK_IMPORTED_MODULE_0_vue__["a" /* default */]({
  el: '#table',
  render: h => h(__WEBPACK_IMPORTED_MODULE_2__components_Table_vue__["a" /* default */]),
  components: {
    'Chrome': __WEBPACK_IMPORTED_MODULE_4_vue_color__["Chrome"]
  }
});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_a55de29a_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_App_vue__ = __webpack_require__(16);
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_a55de29a_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_App_vue__["a" /* default */],
...
var update = __webpack_require__(2)("b6c39472", content, true, {});
...
"use strict";
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{attrs:{"id":"app"}},[_c('img',{attrs:{"src":__webpack_require__(17)}}),_vm._v(" "),_c('h1',[_vm._v(_vm._s(_vm.msg))]),_vm._v(" "),_c('h2',[_vm._v("Essential Links")]),_vm._v(" "),_vm._m(0),_vm._v(" "),_c('h2',[_vm._v("Ecosystem")]),_vm._v(" "),_vm._m(1)])}
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_Table_vue__ = __webpack_require__(5);
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_061457fb_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Table_vue__ = __webpack_require__(21);
function injectStyle (ssrContext) {
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_061457fb_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Table_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(2)("15334ed6", content, true, {});
...
// module
exports.push([module.i, "span.block{border:1px solid #ccc;display:block;flex:none}span.block:hover{border:1px dashed #050490}div#table{height:100vh;width:100vw;display:flex;align-items:center;justify-content:flex-start;flex-direction:column}span.line{display:flex;height:20px;width:100%}*{margin:0;box-sizing:border-box}div#table>.vc-chrome{position:absolute;top:0;right:0;display:none;border-radius:1000px}.vc-chrome>.vc-chrome-body{background:#333}div.tools{position:absolute;top:20px;left:20px}", ""]);
...
"use strict";
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{attrs:{"id":"table"}},[_c('toolbox',{attrs:{"color":_vm.colors}}),_vm._v(" "),_c('chrome-picker',{attrs:{"value":_vm.colors},on:{"input":function($event){return _vm.updateValue($event)}}}),_vm._v(" "),_vm._l((_vm.totalY),function(y){return _c('span',{key:y,staticClass:"line"},_vm._l((_vm.totalX),function(x){return _c('span',{key:x,staticClass:"block",staticStyle:{"width":"20px","height":"20px"},on:{"mouseover":function($event){return _vm.paint($event)}}})}),0)})],2)}
var staticRenderFns = []
var esExports = { render: render, staticRenderFns: staticRenderFns }
/* harmony default export */ __webpack_exports__["a"] = (esExports);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_Toolbox_vue__ = __webpack_require__(6);
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_5f4e49c0_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Toolbox_vue__ = __webpack_require__(25);
function injectStyle (ssrContext) {
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_5f4e49c0_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Toolbox_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(2)("65da1d6e", content, true, {});
...
// module
exports.push([module.i, "div.tools{width:80px;height:80px;border-radius:4000px;background:#333;display:flex;overflow-x:hidden;transition:.25s ease}div.tools>button{height:100%;width:80px;border:none;flex:none;border-radius:100%;background:transparent;color:#fff;font-size:2.5em}", ""]);
...
"use strict";
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"tools",on:{"click":function($event){return _vm.open($event)}}},_vm._l((_vm.tools),function(tool){return _c('button',{staticClass:"tool",on:{"click":function($event){return tool.callback()}}},[_c('i',{class:tool.icon})])}),0)}
var staticRenderFns = []
var esExports = { render: render, staticRenderFns: staticRenderFns }
/* harmony default export */ __webpack_exports__["a"] = (esExports);
